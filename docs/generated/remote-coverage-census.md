...
| Remote-registered (`remote_commands!`) | 243 | `docs/generated/remote-commands.json` |
...
| Ledger rows (exhaustive over `generate_handler!`) | 562 | `docs/generated/remote-commands.json` |
