...
| Remote-registered (`remote_commands!`) | 250 | `docs/generated/remote-commands.json` |
...
| Ledger rows (exhaustive over `generate_handler!`) | 576 | `docs/generated/remote-commands.json` |
