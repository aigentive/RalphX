...
| Remote-registered (`remote_commands!`) | 258 | `docs/generated/remote-commands.json` |
...
| Ledger rows (exhaustive over `generate_handler!`) | 584 | `docs/generated/remote-commands.json` |
