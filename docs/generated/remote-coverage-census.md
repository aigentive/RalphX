...
| Remote-registered (`remote_commands!`) | 256 | `docs/generated/remote-commands.json` |
...
| Ledger rows (exhaustive over `generate_handler!`) | 582 | `docs/generated/remote-commands.json` |
