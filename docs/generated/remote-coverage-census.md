...
| Remote-registered (`remote_commands!`) | 252 | `docs/generated/remote-commands.json` |
...
| Ledger rows (exhaustive over `generate_handler!`) | 578 | `docs/generated/remote-commands.json` |
