...
| Validation timing | Execution agents do not run full baseline task validation by default; pre-change validation is limited to explicit diagnostics, preconditions, or dry-run command selection. |
