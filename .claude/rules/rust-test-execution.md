...
| `suite_commands` | `activity_commands`, `agent_completion_event_runtime`, `agent_profile_commands`, `methodology_commands`, `metrics_commands`, `qa_commands`, `release_notes_commands`, `research_commands`, `workflow_commands`, `artifact_commands`, `review_commands`, `review_service`, `plan_branch_commands`, `conversation_stats_commands`, `execution_commands_running_count`, `question_commands`, `git_commands` |
