...
| `readonly_tools` | `Read`, `Grep`, `Glob`, `WebFetch`, `WebSearch` | `config/harnesses/claude.yaml` |
...
- task execution/review/coder prompts may use `<task_runtime_context>` as bootstrap context, but `get_task_context` remains the authoritative task refresh when bootstrap context is absent, blocked, stale/incomplete, or full task details are needed
...
> Last partially updated: 2026-07-02 against canonical `agents/*/agent.yaml` metadata for the Agent conversation surfaces touched here.

| Agent | Canonical MCP tools |
|-------|--------------------------------------|
| `ralphx-general-explorer` | `fs_read_file`, `fs_list_dir`, `fs_grep`, `fs_glob`, `get_artifact`, `propose_plan_mode`, `delegate_start`, `delegate_wait`, `delegate_cancel`, `get_agent_task`, `list_agent_tasks`, `search_memories`, `get_memory`, `get_memories_for_paths` |
| `ralphx-general-worker` | `fs_read_file`, `fs_list_dir`, `fs_grep`, `fs_glob`, `get_artifact`, `propose_plan_mode`, `get_agent_workspace_publish_status`, `check_agent_workspace_publish_readiness`, `update_agent_workspace_from_base`, `publish_agent_workspace`, `delegate_start`, `delegate_wait`, `delegate_cancel`, `create_agent_task`, `get_agent_task`, `list_agent_tasks`, `update_agent_task`, `claim_agent_task`, `complete_agent_task`, `search_memories`, `get_memory`, `get_memories_for_paths` |
...
| `ralphx-ideation` profile `plan` | `fs_read_file`, `fs_list_dir`, `fs_grep`, `fs_glob`, `create_plan_artifact`, `update_plan_artifact`, `edit_plan_artifact`, `get_artifact`, `get_session_plan`, `ask_user_question`, `get_plan_verification`, `stop_verification`, `delegate_start`, `delegate_wait`, `delegate_cancel`, `search_memories`, `get_memory`, `get_memories_for_paths`, `get_conversation_transcript` |
...
| `ralphx-utility-pr-describer` | `submit_agent_workspace_pr_description` |
| `ralphx-pr-reviewer` | `fs_read_file`, `fs_list_dir`, `fs_grep`, `fs_glob`, `get_artifact`, `get_pr_review_context`, `write_pr_review_artifact`, `propose_pr_review_action`, `complete_pr_review_run`, `delegate_start`, `delegate_wait`, `delegate_cancel`, `get_agent_task`, `list_agent_tasks`, `search_memories`, `get_memory`, `get_memories_for_paths` |
...
| `ralphx-execution-worker` | `start_step`, `complete_step`, `skip_step`, `fail_step`, `add_step`, `get_step_progress`, `get_step_context`, `get_sub_steps`, `get_task_context`, `get_artifact`, `get_artifact_version`, `get_related_artifacts`, `search_project_artifacts`, `get_review_notes`, `get_task_steps`, `get_task_issues`, `mark_issue_in_progress`, `mark_issue_addressed`, `get_project_analysis`, `run_task_validation`, `create_followup_agent_conversation`, `register_agent_issue`, `delegate_start`, `delegate_wait`, `delegate_cancel`, `create_agent_task`, `get_agent_task`, `list_agent_tasks`, `update_agent_task`, `claim_agent_task`, `complete_agent_task`, `execution_complete`, `search_memories`, `get_memory`, `get_memories_for_paths` |
| `ralphx-execution-coder` | `start_step`, `complete_step`, `skip_step`, `fail_step`, `add_step`, `get_step_progress`, `get_step_context`, `get_task_context`, `get_artifact`, `get_artifact_version`, `get_related_artifacts`, `search_project_artifacts`, `get_review_notes`, `get_task_steps`, `get_task_issues`, `mark_issue_in_progress`, `mark_issue_addressed`, `get_project_analysis`, `run_task_validation`, `delegate_start`, `delegate_wait`, `delegate_cancel`, `create_agent_task`, `get_agent_task`, `list_agent_tasks`, `update_agent_task`, `claim_agent_task`, `complete_agent_task`, `search_memories`, `get_memory`, `get_memories_for_paths` |
...
| `ralphx-execution-reviewer` | `complete_review`, `get_task_context`, `get_artifact`, `get_artifact_version`, `get_related_artifacts`, `search_project_artifacts`, `get_review_notes`, `get_task_steps`, `get_task_issues`, `get_step_progress`, `get_issue_progress`, `get_project_analysis`, `get_task_validation_summary`, `get_task_diff_stat`, `get_task_diff`, `create_followup_agent_conversation`, `register_agent_issue`, `delegate_start`, `delegate_wait`, `delegate_cancel`, `search_memories`, `get_memory`, `get_memories_for_paths` |
