...
export const AGENT_GATED_AFFORDANCES = {
  ...
  ticketingContainersRead: "list_ticketing_containers",
  ticketingColumnsSync: "list_ticketing_columns",
  ticketingStatusCatalogRefresh: "refresh_ticketing_status_catalog",
  ticketingStatusPresentationUpdate: "update_ticketing_status_presentation",
  ticketingTicketsRead: "list_tickets",
  ticketingFilterOptionsRead: "list_ticket_filter_options",
  ticketingDetailRead: "get_ticket_detail",
  ticketingTransitionsRead: "list_ticket_transitions",
  ticketingTransitionWrite: "transition_ticket_status",
  ticketingAssignWrite: "assign_ticket",
  ticketingClearAssigneeWrite: "clear_ticket_assignee",
  ticketingCommentWrite: "add_ticket_comment",
  ticketingLabelsWrite: "set_ticket_labels",
  ticketingLabelsRead: "list_ticket_labels",
