...
export const AGENT_CONTROL_MANIFEST_SCHEMA_VERSION = 1;
...
export const AGENT_CONTROL_COMMANDS = [
  ...
  "get_custom_agent_profiles",
  "get_effective_manual_role_default",
