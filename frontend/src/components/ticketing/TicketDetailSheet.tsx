        ...
        {canPreview && (
          ...
          >
            <img
              ...
              onError={() => setFailed(true)}
            />
            <span className="absolute inset-0 flex items-center justify-center bg-transparent text-[var(--text-primary)] opacity-0 transition group-hover:bg-[var(--overlay-scrim)] group-hover:opacity-100 group-focus-visible:bg-[var(--overlay-scrim)] group-focus-visible:opacity-100">
