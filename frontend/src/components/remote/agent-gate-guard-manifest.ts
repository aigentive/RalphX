...
export const GATE_WIRED_FILES: readonly string[] = [
  ...
  "src/components/agents/useAgentConversationActions.ts",
  "src/components/Chat/ChatInput.tsx",
  "src/components/Chat/IntegratedChatPanel.tsx",
  "src/components/Chat/PersonaChip.tsx",
  "src/components/Chat/QueuedMessage.tsx",
  "src/components/PermissionDialog.tsx",
  "src/components/Ideation/FinalizeConfirmationDialog.tsx",
  "src/hooks/useQuestionInput.ts",
  "src/hooks/useFreshnessBlockedNotification.ts",
  "src/hooks/useIdeationEvents.ts",
