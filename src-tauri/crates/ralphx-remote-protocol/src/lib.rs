...
pub const EVENT_CLASSIFICATIONS: &[EventClassification] = &[
    ...
    backend("delegation_park:needs_attention", EventDelivery::Durable),
    backend("team:member_status", EventDelivery::Durable),
    backend("team:member_updated", EventDelivery::Durable),
    backend("team:roster_updated", EventDelivery::Durable),
    ...
    backend("agent:thinking", EventDelivery::Transient),
    backend("agent:thinking_progress", EventDelivery::Transient),
