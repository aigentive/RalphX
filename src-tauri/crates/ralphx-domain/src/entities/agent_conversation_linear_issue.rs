...
pub enum AgentConversationLinearRefreshStatus {
    NotLoaded,
    Loaded,
    Error,
}

impl std::fmt::Display for AgentConversationLinearRefreshStatus {
...
impl FromStr for AgentConversationLinearRefreshStatus {
    type Err = String;
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value {
            ...
            "error" => Ok(Self::Error),
            _ => Err(format!("unknown Linear refresh status: '{value}'")),
        }
    }
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct AgentConversationLinearIssueLink {
    ...
    pub refresh_status: AgentConversationLinearRefreshStatus,
...
impl AgentConversationLinearIssueLink {
    pub fn new(
        ...
        Self {
            ...
            refresh_status: AgentConversationLinearRefreshStatus::NotLoaded,
            refresh_error: None,
            assigned_at,
