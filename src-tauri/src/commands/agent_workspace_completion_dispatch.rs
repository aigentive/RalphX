...
use crate::shell::agent_completion_event_runtime::{
    create_agent_completion_event_runtime, CompletionCorrelationRegistry,
    CompletionCorrelationSource,
};
...
fn install_completion_dispatch_with_consumers<R: Runtime>(
    app_handle: &tauri::AppHandle<R>,
    bus: InternalEventBus,
    correlation: Arc<CompletionCorrelationRegistry>,
    consumers: CompletionConsumers,
