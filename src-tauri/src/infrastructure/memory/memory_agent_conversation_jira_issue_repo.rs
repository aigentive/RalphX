...
use crate::domain::entities::{AgentConversationJiraIssueLink, ChatConversationId};
use crate::domain::repositories::AgentConversationJiraIssueRepository;
use crate::error::AppResult;

pub struct MemoryAgentConversationJiraIssueRepository {
    links: RwLock<HashMap<ChatConversationId, AgentConversationJiraIssueLink>>,
}

impl MemoryAgentConversationJiraIssueRepository {
    pub fn new() -> Self {
        Self {
...
impl Default for MemoryAgentConversationJiraIssueRepository {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl AgentConversationJiraIssueRepository for MemoryAgentConversationJiraIssueRepository {
