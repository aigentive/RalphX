...
fn build_initial_prompt_with_history(
    ...
    match context_type {
        ...
        ChatContextType::Delegation => {
            format!(
                "<instructions>\n\
                 RalphX Delegated Specialist Session. Complete the authoritative delegated assignment within this isolated specialist context.\n\
                 The backend provides delegation lineage separately from the one executable assignment.\n\
                 </instructions>\n\
                 <data>\n\
