...
pub(crate) use merge_helpers::{
    ...
    compute_source_update_worktree_path, create_draft_pr_if_needed,
    draft_plan_pr_description_for_write, extract_commit_hook_merge_error, get_trigger_origin,
    has_branch_missing_metadata, has_main_merge_deferred_metadata, has_merge_deferred_metadata,
    is_commit_hook_merge_error_text, is_main_merge_deferred_timed_out, is_merge_deferred_timed_out,
    is_merge_worktree_path, is_pr_branch_publication_conflict_routed_error,
    ...
    resolve_plan_branch_pr_base, resolve_task_plan_branch_record, restore_task_worktree,
    set_conflict_metadata, set_source_conflict_resolved,
