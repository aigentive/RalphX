...
crate::remote_commands! {
    ...
    "request_remote_plan_approval"
        => crate::commands::remote_plan_commands::request_remote_plan_approval {
        class: AgentControl,
        caps: [SeedsSpawnTriggeringState],
        params: [(arg input: crate::commands::remote_plan_commands::RequestRemotePlanApprovalInput), (app_state)],
        call: async,
        result: fallible,
    },
    "get_remote_plan_approval_request"
        => crate::commands::remote_plan_commands::get_remote_plan_approval_request {
        class: Read,
        caps: [],
        params: [(arg request_id: String), (app_state)],
        call: async,
    ...
    "request_remote_automation_draft"
        ...
        params: [
            (arg project_id: String),
            (arg name: String),
            (arg authoring_mode: String),
            (arg base_ref_kind: String),
            (arg base_branch_mode: String),
            (arg base_branch: Option<String>),
            (app_state),
        ],
        call: async,
        result: fallible,
    ...
    "get_remote_automation_draft_request"
        => crate::commands::remote_automation_commands::get_remote_automation_draft_request {
        class: Read,
        caps: [],
        params: [(arg request_id: String), (app_state)],
        call: async,
    ...
    "list_ticketing_containers" => crate::commands::ticketing_commands::list_ticketing_containers {
        class: Read,
        caps: [],
        params: [(arg provider: String), (arg project_id: Option<String>), (arg parent_container_id: Option<String>), (app_state)],
        call: async,
        result: fallible,
    },
    "list_ticketing_columns" => crate::commands::ticketing_commands::list_ticketing_columns {
        class: AgentControl,
        caps: [],
        params: [(arg provider: String), (arg container_id: Option<String>), (app_state)],
        call: async,
        result: fallible,
    },
    ...
    "refresh_ticketing_status_catalog" => crate::commands::ticketing_commands::refresh_ticketing_status_catalog {
        class: AgentControl,
        caps: [],
        params: [(arg provider: String), (arg scope_kind: String), (arg scope_id: String), (app_state)],
        call: async,
    ...
    "update_ticketing_status_presentation" => crate::commands::ticketing_commands::update_ticketing_status_presentation {
        class: AgentControl,
        caps: [],
        params: [(arg input: crate::commands::ticketing_commands::UpdateTicketingStatusPresentationInput), (app_state)],
        call: async,
        result: fallible,
    },
    "list_tickets" => crate::commands::ticketing_commands::list_tickets {
        class: Read,
        caps: [],
        params: [(arg query: crate::commands::ticketing_commands::ListTicketsQuery), (app_state)],
        call: async,
        result: fallible,
    },
    "list_ticket_filter_options" => crate::commands::ticketing_commands::list_ticket_filter_options {
        class: Read,
        caps: [],
        params: [(arg query: crate::commands::ticketing_commands::ListTicketFilterOptionsQuery), (app_state)],
        call: async,
        result: fallible,
    },
    "get_ticket_detail" => crate::commands::ticketing_commands::get_ticket_detail {
        class: Read,
        caps: [],
        params: [(arg provider: String), (arg ticket_ref: crate::commands::ticketing_commands::TicketRefInput), (app_state)],
        call: async,
        result: fallible,
    },
    "list_ticket_transitions" => crate::commands::ticketing_commands::list_ticket_transitions {
        class: Read,
        caps: [],
        params: [(arg provider: String), (arg ticket_ref: crate::commands::ticketing_commands::TicketRefInput), (app_state)],
        call: async,
    ...
    "transition_ticket_status" => crate::commands::ticketing_commands::transition_ticket_status {
        class: AgentControl,
        caps: [],
        params: [(arg input: crate::commands::ticketing_commands::TransitionTicketStatusInput), (host_app_handle), (app_state)],
        call: async,
        result: fallible,
    },
    "assign_ticket" => crate::commands::ticketing_commands::assign_ticket {
        class: AgentControl,
        caps: [],
        params: [(arg input: crate::commands::ticketing_commands::AssignTicketInput), (host_app_handle), (app_state)],
        call: async,
        result: fallible,
    },
    "clear_ticket_assignee" => crate::commands::ticketing_commands::clear_ticket_assignee {
        class: AgentControl,
        caps: [],
        params: [(arg input: crate::commands::ticketing_commands::AssignTicketInput), (host_app_handle), (app_state)],
        call: async,
    ...
    "add_ticket_comment" => crate::commands::ticketing_commands::add_ticket_comment {
        class: AgentControl,
        caps: [],
        params: [(arg input: crate::commands::ticketing_commands::AddTicketCommentInput), (host_app_handle), (app_state)],
        call: async,
        result: fallible,
    },
    "set_ticket_labels" => crate::commands::ticketing_commands::set_ticket_labels {
        class: AgentControl,
        caps: [],
        params: [(arg input: crate::commands::ticketing_commands::SetTicketLabelsInput), (host_app_handle), (app_state)],
        call: async,
        result: fallible,
    },
    "list_ticket_labels" => crate::commands::ticketing_commands::list_ticket_labels {
        class: Read,
        caps: [],
        params: [(arg provider: String), (arg ticket_ref: crate::commands::ticketing_commands::TicketRefInput), (app_state)],
        call: async,
