...
#[test]
fn test_stream_end_without_completion_is_not_reported_as_the_stale_tool_diagnostic() {
    ...
    let result = classify_codex_stream_failure(&runtime_errors, &local_tool_errors, Some(0), false)
...
#[test]
fn test_local_tool_diagnostics_are_bounded_in_the_terminal_message() {
    let runtime_errors = Vec::<String>::new();
...
#[test]
fn test_agent_exit_stderr_is_bounded_when_runtime_and_tool_errors_are_huge() {
