...
export declare function callAgentWorkspaceTool(name: string, callTauri: TauriPost, callTauriGet: TauriGet, args: unknown): Promise<unknown>;
export declare function callGetAgentWorkspacePublishStatusTool(callTauriGet: TauriGet, args: unknown): Promise<unknown>;
