...
describe("task runtime prompt contract", () => {
    ...
    it.each(taskAgentPromptPaths)("%s treats injected runtime context as bootstrap-only task context", (relativePath) => {
        ...
        expect(prompt).not.toMatch(/visible synthetic|synthetic user-message|Execute task:|Review task:|Re-execute task/i);
    });
...
//# sourceMappingURL=task-runtime-prompt-contract.test.js.map