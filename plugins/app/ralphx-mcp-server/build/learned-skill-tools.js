...
export const LEARNED_SKILL_TOOLS = [
    ...
    },
    {
        ...
        description: "Fetch one learned project skill by stable project_skill_id within the active project. Read-only; returns full guidance and provenance.",
        inputSchema: {
            type: "object",
            properties: {
                project_id: PROJECT_ID,
    ...
    },
    {
        ...
        description: "Create a staged project skill or update its canonical title/bucket/stage match. Runtime attribution is supplied by RalphX.",
        inputSchema: {
            type: "object",
    ...
    },
    {
        ...
        description: "Patch a known project skill through the canonical resolution and versioning flow. Runtime attribution is supplied by RalphX.",
        inputSchema: {
            type: "object",
            properties: {
                project_skill_id: {
    ...
    },
    {
        ...
        description: "Retire an unpinned staged, approved, or stale project skill. Repeating an already-retired request is safe.",
        inputSchema: {
            type: "object",
            properties: {
                project_id: PROJECT_ID,
