    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                hunk_annotations: {
                    type: "array",
                    description: "Optional structured hunk-level review notes. Use only hunk anchors returned in target.review_packet.hunk_anchors; omit anchors you cannot describe confidently.",
                    items: {
                        type: "object",
                        properties: {
                            path: {
