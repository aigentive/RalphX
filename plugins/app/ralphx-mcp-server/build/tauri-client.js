...
let tauriHttpTransport = executeNodeHttpRequest;
export function __setTauriHttpTransportForTests(transport) {
...
function parseValidatedTauriUrl(url) {
...
async function executeNodeHttpRequest(url, init) {
