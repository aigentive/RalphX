...
export const TICKET_ATTACHMENT_TOOLS = [
    {
        ...
        description: "List normalized attachment metadata for a referenced Jira, Linear, or ClickUp ticket. " +
...
const TICKET_ATTACHMENT_TOOL_NAMES = new Set(TICKET_ATTACHMENT_TOOLS.map((tool) => tool.name));
