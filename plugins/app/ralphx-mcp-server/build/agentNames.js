...
export const GENERAL_EXPLORER = "ralphx-general-explorer";
export const GENERAL_WORKER = "ralphx-general-worker";
export const PR_REVIEWER = "ralphx-pr-reviewer";
export const AGENT_WORKSPACE_REPAIR = "ralphx-agent-workspace-repair";
...
export const PERSONA_EXTRACTOR = "ralphx-persona-extractor";
...
export const PLAN_CRITIC_IMPLEMENTATION_FEASIBILITY = "ralphx-plan-critic-implementation-feasibility";
...
export const IDEATION_SPECIALIST_PROMPT_QUALITY = "ralphx-ideation-specialist-prompt-quality";
export const IDEATION_SPECIALIST_INTENT = "ralphx-ideation-specialist-intent";
export const IDEATION_SPECIALIST_PIPELINE_SAFETY = "ralphx-ideation-specialist-pipeline-safety";
export const IDEATION_SPECIALIST_STATE_MACHINE = "ralphx-ideation-specialist-state-machine";
