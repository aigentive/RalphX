...
export const VALIDATION_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Read persisted validation evidence for a task. Reviewers use this read-only tool instead of running validation.",
    inputSchema: {
      type: "object",
      properties: {
        task_id: {
  ...
  },
  {
    ...
    description:
      "Read a bounded stat summary of task worktree changes against the task review base. Read-only reviewer replacement for git diff --stat.",
    inputSchema: {
      type: "object",
      properties: {
        task_id: {
  ...
  },
  {
    name: "get_task_diff",
    description:
      "Read bounded task worktree file diffs against the task review base. Read-only reviewer replacement for git diff.",
    inputSchema: {
      type: "object",
      properties: {
        task_id: {
