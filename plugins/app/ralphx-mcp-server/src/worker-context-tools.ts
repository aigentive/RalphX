...
export const WORKER_CONTEXT_TOOLS: Tool[] = [
  {
    ...
    description:
      "Fetch authoritative task context including source proposal, implementation plan, blockers, scope drift, and related artifacts. Use when injected bootstrap context is absent, stale, incomplete, blocked, or when full task details are needed.",
    inputSchema: {
      type: "object",
      properties: {
        task_id: {
  ...
  },
  {
    name: "get_artifact",
    description:
      "Retrieve the full content of any artifact by ID. Use when task context or composer-selected artifact references provide a plan/artifact id and full content is needed.",
    inputSchema: {
      type: "object",
      properties: {
        artifact_id: {
