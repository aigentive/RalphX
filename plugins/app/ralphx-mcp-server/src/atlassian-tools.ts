...
export const ATLASSIAN_TOOLS: Tool[] = [
  // ========================================================================
  // READ TIER
  // ========================================================================
  {
  ...
  },
  {
    name: "jira_get_issue",
    description:
      "Read a single Jira issue including summary, description, status, and assignee.",
    inputSchema: {
      type: "object",
      properties: {
        issueKey: {
  ...
  },
  {
    ...
    description:
      "Read a Confluence page including its full storage-format body. " +
  ...
  },
  {
    ...
    description:
      "Escape hatch for Atlassian REST endpoints with no dedicated tool. " +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        path: {
          type: "string",
          description:
            "Relative API path, for example '/rest/agile/1.0/board/5/sprint'. Absolute URLs are rejected.",
        },
        body: {
          type: "object",
  ...
  },
  {
    ...
    description:
      "Update summary, description, labels, or priority on a Jira issue. " +
...
const ATLASSIAN_TOOL_ENDPOINTS: Record<string, string> = {
...
export function isAtlassianToolName(name: string): boolean {
...
export async function callAtlassianTool(
  ...
  callTauri: TauriPost,
  args: unknown,
  runtimeContext?: AtlassianToolRuntimeContext,
): Promise<unknown> {
