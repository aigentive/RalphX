...
3. Resolve every reported conflict deliberately, verify there are no unmerged paths or conflict markers, and load the relevant validation with `get_project_analysis` before calling `run_task_validation`.
